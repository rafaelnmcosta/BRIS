...
namespace bris_API.Migrations
{
    ...
    [Migration("20240828072415_RefatoradoCorrigido")]
    partial class RefatoradoCorrigido
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("bris_API.Models.Senha", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Salt = "xG5uQnY/KXtXQXJY3J779Q==",
                            SenhaHash = "WRU3XScAPAlQZlCJzof8sSImisXrbZ8PWZ5dQ1C4PZk=",
                            UsuarioId = 1
                        });
                });
