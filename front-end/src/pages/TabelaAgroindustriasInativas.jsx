...
const TabelaAgroindustriasInativas = () => {
    ...
    const carregarAgroindustrias = async () => {
        try {
            const dados = await agroindustrias.listarAgroindustriasInativas();
            setAgroLista(dados);
        } catch (err) {
    ...
    return <TemplateTabelaAgroindustrias tipo="Agroindústria" lista={agroLista} ativos={false} onAtualizar={carregarAgroindustrias}/>;
};

export default TabelaAgroindustriasInativas;
